...
import WebProfileBrandItemsFormModal from './WebProfileBrandItemsFormModal.vue';
import { se } from 'date-fns/locale';

const props = defineProps({
  id: Object, // untuk edit
...
function open_list_menu(ds) {
  ...
  // router.visit(route('webprofilebrandslistmenu.index', d.id));
}

function openCreate(id) {
  modalMode.value = 'create';
  selectedId.value = id; // set id untuk form
    ...
    <div class="max-w-7xl w-full mx-auto py-8 px-2">
      <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800 flex items-center gap-2">
          <i class="fa-solid fa-users text-blue-500"></i> Data Brands >> Data Brand Lists
        </h1>
        <button @click="openCreate(id)" class="bg-gradient-to-r from-blue-500 to-blue-700 text-white px-4 py-2 rounded-xl shadow-lg hover:shadow-2xl transition-all font-semibold">
          + Buat Data Brands Items Baru
        </button>
      </div>
        ...
        <table class="w-full min-w-full divide-y divide-gray-200">
          <thead class="bg-gradient-to-r from-blue-50 to-blue-100">
            <tr>
              ...
              <th class="px-6 py-3 text-left text-xs font-bold text-blue-700 uppercase tracking-wider">Nama Brands List</th>
              <th class="px-6 py-3 text-left text-xs font-bold text-blue-700 uppercase tracking-wider">Link PDF</th>
                ...
                <div class="relative inline-block min-w-[120px] text-left">
                  ...
                  <div v-if="openDropdown === (d.current_page - 1) * d.per_page + key + 1"
                    ...
                    <ul class="text-sm text-gray-700">
                      <li>
                        <button @click="open_edit(id ,ds)" class="block w-full text-left px-4 py-2 hover:bg-gray-100">Edit</button>
                      </li>
                      <li>
                        <button @click="open_list_menu(ds)" class="block w-full text-left px-4 py-2 hover:bg-gray-100">Link Menu</button>
                      </li>
                      <!-- <li>
