    ...
    <div class="max-w-7xl w-full mx-auto py-8 px-2">
      <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800 flex items-center gap-2">
          <i class="fa-solid fa-users text-blue-500"></i> Data News
        </h1>
        ...
        <table class="w-full min-w-full divide-y divide-gray-200">
          <thead class="bg-gradient-to-r from-blue-50 to-blue-100">
            <tr>
              ...
              <th class="px-6 py-3 text-left text-xs font-bold text-blue-700 uppercase tracking-wider">Detail</th>
          ...
          <tbody>
            ...
            <tr v-for="(ds, key) in d.data" :key="ds.id" class="hover:bg-blue-50 transition shadow-sm">
              ...
              <td class="px-6 py-3" v-html="ds.judul"></td>
              <td class="px-6 py-3" v-html="detailLimit(ds.detail)"></td>
              <td class="px-6 py-3">
                <img 
                  :src="`https://justusmember.co.id/assets/file_news/${ds.picture}`" 
                  alt="Brand Image" 
