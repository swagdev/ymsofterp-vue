...
class MasterPayrollController extends Controller
{
    public function index(Request $request)
    {
        ...
        // if (!empty($request->id_divisi)) {
            ...
            $query = User::join('tbl_data_jabatan as jab', 'jab.id_jabatan', '=', 'users.id_jabatan')
                    ->join('tbl_data_outlet as outlet', 'outlet.id_outlet', '=', 'users.id_outlet')
                    ->leftJoin('tbl_master_gaji as mgaji', 'mgaji.user_id', '=', 'users.id')
                    ->select('users.id as user_user_id', 'users.nama_lengkap', 'users.id_jabatan', 'jab.nama_jabatan', 'jab.id_atasan', 'outlet.id_outlet', 'outlet.nama_outlet', 'mgaji.*')
        ...
        return Inertia::render('MasterPayroll/Index', [
            'd' => $d,
            'jabatans' => $jabatans,
            'divisis' => $divisis,
            'outlets' => $outlets,
